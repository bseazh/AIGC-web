    ...
    try {
      ...
      const prompt = isPerson
        ? [
            ...
            "请把输入图中的服装、穿搭或人物信息作为参考，生成一位原创虚拟模特穿着该服装的完整人体多角度参考板。",
        ...
        : kind === "scene"
          ? [
              "任务类型：场景/背景多视图参考。",
              "基于输入场景图，生成一张电商视频复刻可用的场景多角度参考板。",
              "包含正面空间、左侧角度、右侧角度、纵深角度、近景材质、光线氛围、背景层次、可摆放主体区域。",
              "保留输入场景的色调、光线、空间关系、材质和氛围，不要生成清晰人物脸、品牌水印或不可控文字。",
              "输出浅灰或白色边框的整洁多视图参考板，适合作为后续 @场景多视图参考 使用。",
            ].join("\n")
          : [
              "任务类型：商品/物体多视图参考。",
              "基于输入商品或物体图，生成一张电商复刻可用的商品多角度参考板。",
              "包含主体正面、左45度、右45度、侧面、背面/反面、顶部或底部、材质细节、比例关系或使用场景小图。",
              "必须保留主体轮廓、颜色、材质、结构、Logo位置和关键卖点，不要凭空改变品类。",
