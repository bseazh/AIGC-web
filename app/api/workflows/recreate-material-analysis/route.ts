  ...
  const content: Array<Record<string, unknown>> = [
    {
      ...
      text: [
        ...
        "person：真人、模特、人物半身/全身/脸部/肢体穿搭；只要图片中能看到完整人体、人体轮廓、穿着服装的人、模特试穿效果，就必须优先判为 person。",
        "product：商品主体、服装平铺、包装、配件、静物；只有在服装/商品独立展示、没有人体或模特轮廓时，才判为 product。",
        "scene：背景、空间、室内外环境、氛围参考。",
        "text：Logo、品牌字样、字幕、海报文字占主导。",
        "如果包含可识别真人脸、真人人物、模特身体、试穿姿态或人体轮廓，请优先判为 person，并在 suggestedAction 中建议生成隐私化多角度人物参考。",
