...
> 目标：记录 `https://yinghai.xin/` 公开首页与登录弹窗所呈现的设计语言，供创建同类产品时参考。本文不授权复制原站品牌、商标、媒体素材或未公开页面。所有“观察”来自 2026-07-16 的浏览器渲染结果；登录后的应用壳部分仅在公开样式表中可见，相关结论会明确标为推断。
