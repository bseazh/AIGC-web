...
| AI带货模特 | 创作专属带货模特 | `/create/model-wear` | Older custom model-wear page | Needs later visual alignment |
| AI带货模特 | 模特穿搭图 | `/create/model-wear` | Same route as above | Needs split or relabel |
| 电商商品图制作 | 商品主图+详情页 | `/create/product-hero` | Generic image workflow page | Needs later visual alignment |
| 电商商品图制作 | 商品详情页（百货） | `/create/product-detail` | Generic image workflow page | Needs later visual alignment |
| 电商商品图制作 | 复制详情页 | `/create/recreate-detail-page` | Generic image workflow page | Needs later visual alignment |
| 电商商品图制作 | 复制主图 | `/create/recreate-product-hero` | Generic image workflow page | Needs later visual alignment |
| 图片处理 | 调整图片比例 | `/create/resize-image` | Generic image workflow page | Needs later visual alignment |
| 图片处理 | 白底图生成 | `/create/white-background` | Generic image workflow page | Needs later visual alignment |
| 图片处理与优化 | 商品图高清优化 | `/create/hd-enhance` | Generic image workflow page | Needs later visual alignment |
