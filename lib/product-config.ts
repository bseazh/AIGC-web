...
export const recreateReferenceWorkflow = { ...sceneImageWorkflow, key: "recreate-reference-image", name: "复刻素材参考图", pointsPerTask: Number(process.env.RECREATE_REFERENCE_TASK_POINTS || 10), scenes: ["人物多视图", "商品多视图", "场景多视图"], styles: ["参考板", "隐私遮挡", "真实摄影"] } as const;
