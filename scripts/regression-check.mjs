...
const checks = [
  ...
  [
    "Generation result cards expose download and save actions",
    "app/components/generated-asset-actions.tsx",
    "添加到素材库",
    "/api/assets/${output.assetId}/download/",
    "/api/assets/${output.assetId}/save/",
  ],
  [
  ...
  [
    "Shared video workflows use manual result saving",
    "app/components/video-workflow-page.tsx",
    "GeneratedAssetActions",
    "TemporaryResultNotice",
    "draftId: projectId",
  ...
  [
    "Product ad video uses manual result saving",
    "app/components/product-ad-video-page.tsx",
    "GeneratedAssetActions",
    "TemporaryResultNotice",
    "draftId: projectId",
  ...
  [
    "Recreate video uses manual result saving",
    "app/features/recreate-video/components/panels/generate-panel.tsx",
    "GeneratedAssetActions",
    "结果临时保留 48 小时",
  ],
  [
    "Product director outputs use manual result saving",
  ...
  [
    "Client-derived generation assets are temporary outputs",
  ...
  [
    "Recreate generated collages request temporary storage",
    "app/features/recreate-video/hooks/use-recreate-keyframes.ts",
    "temporaryDerived: true",
  ],
  [
    "Saved outputs and user uploads are not age-deleted",
    "scripts/storage-cleanup.mjs",
    'retainedAssets: "USER_INPUTS_AND_SAVED_OUTPUTS"',
  ],
  [
    "Project workspaces restore their latest task result",
    "app/components/generated-asset-actions.tsx",
    "loadProjectTaskResult",
    "restoredTaskPhase",
  ],
  [
