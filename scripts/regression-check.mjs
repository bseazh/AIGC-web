...
const checks = [
  ...
  [
    "Image workflows declare a shared capability spec",
  ...
  [
    ...
    "assistantOutputCounts",
  ],
  [
    "Creation assistant API enforces server-side assistant modes",
  ...
  [
    "Image workflow entry points pass their capability keys",
    "app/features/image-creation/product-hero/product-hero-workspace.tsx",
    'workflowKey="product-hero-image"',
    "app/features/image-creation/white-background/white-background-workspace.tsx",
  ...
  [
    "AI image references carry explicit user-selected roles",
    "app/features/image-creation/ai-image/ai-image-generate-page.tsx",
    'referenceRoles: references.map',
    '主体身份',
    '商品细节',
    '视觉风格',
    '构图布局',
  ...
  [
    "AI image prompt follows a reference execution protocol",
    "scripts/worker.mjs",
    '必须先逐张读取图片，再进行生成',
    '主体/商品身份约束不得被风格、构图或场景参考覆盖',
    '生成后内部自检',
  ],
  [
    "Product scene references remain independent products",
    "scripts/worker.mjs",
    '独立商品源图',
    '不得与其他参考图商品融合',
    '多商品真实场景合成',
